...
var _userProvider = require('../user-provider.helper');

var _userProvider2 = _interopRequireDefault(_userProvider);

var _fixturesLoader = require('../fixtures/fixtures-loader.helper');
...
var _variableStore = require('../variable-store.helper');
